...
;**** you may want to write your own equates here *****
          ...
          LDY     #200
          STY     long_delay                ; initialise delay for scrolling
...
digit_general:
          LDAA    sevenSegEnabler     ; need to write the value read from PORTH to PORTP
          STAA    PTP                 ; to enable required LED  
          STAB    PORTB
          BSR     delay
          RTS               
...
getSevenSegCode:                        ; ascii lookup table
 ...
 choiceOfDigits:    
          LDAB    #$06    ; load accumulator B with digit to be displayed
